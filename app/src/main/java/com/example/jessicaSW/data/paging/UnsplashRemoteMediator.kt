package com.example.jessicaSW.data.paging
...
import com.example.jessicaSW.data.local.UnsplashDatabase
import com.example.jessicaSW.data.remote.UnsplashApi
import com.example.jessicaSW.model.UnsplashImage
import com.example.jessicaSW.model.UnsplashRemoteKeys
import com.example.jessicaSW.util.Constants.API_KEY
import com.example.jessicaSW.util.Constants.ITEMS_PER_PAGE
...
class UnsplashRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val response = unsplashApi.getAllImages(token = API_KEY, page = currentPage, perPage = ITEMS_PER_PAGE)
